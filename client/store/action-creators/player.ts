...
export const setPrevActiveTrack = (payload: ITrack): PlayerAction => {
    return {type: PlayerActionTypes.SET_PREV_ACTIVE, payload}
}
...
export const setNextPlaylist = (payload: ITrack[]): PlayerAction => {
    return {type: PlayerActionTypes.SET_NEXT_PLAYLIST, payload}
}
